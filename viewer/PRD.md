...
9. Launching `/pm-competitors-intel` spawns a `claude -p` background process in the project folder; each turn's exit triggers an artifact refresh and, on completion, a macOS user notification (success or failure).
