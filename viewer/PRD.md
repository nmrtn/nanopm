...
9. Launching `/pm-competitors-intel` spawns a headless `claude -p` background process in the project folder; process exit triggers an artifact refresh and a macOS user notification (success or failure).
